...
//  Locations
//
//  Created by Jay Phillips on 7/26/22.
//
...
class MapViewController: UIViewController {
    ...
    func region(for annotations: [MKAnnotation]) -> MKCoordinateRegion {
        ...
        default:
            ...
            let center = CLLocationCoordinate2D(latitude: topLeft.latitude - bottomRight.latitude / 2, longitude: topLeft.longitude - bottomRight.longitude / 2)
